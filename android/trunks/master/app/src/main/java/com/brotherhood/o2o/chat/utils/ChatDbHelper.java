...
import com.brotherhood.o2o.chat.db.SimpleDatabaseHelper;
...
public class ChatDbHelper extends SimpleDatabaseHelper {
    ...
    public static class SessionItem {
         ...
         * 额外字段1（用户头像url）
         */
        public static final String COL_AVATAR_URL = "_ext1";

        /**
         * 额外字段2（用户昵称）
         */
        public static final String COL_NICKNAME = "_ext2";

        /**
         * 额外字段3（用户昵称）
         */
        public static final String COL_GENDER = "_ext3";
