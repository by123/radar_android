...
public class ImageLoader {
	...
	/**
	 * listview 列表加载图片专用(使用了convertView并使用了异步加载)
	 * */
	public static ImageListener getImageListener(final ImageView view, final String imgUrl, final int defaultImageResId, final int errorImageResId) {
		if (view == null)
			return null;
		...
		return new ImageListener() {
			...
			public void onErrorResponse(VolleyError error) {
				if (errorImageResId != 0) {
					if (view.getTag() != null && view.getTag().equals(imgUrl)) {
...
//					view.setScaleType(ScaleType.CENTER_CROP);
	...
	public ImageContainer get(String requestUrl, ImageListener imageListener, int maxWidth, int maxHeight) {
		...
		// if(request != null && imageContainer.getBitmap() == null) {
