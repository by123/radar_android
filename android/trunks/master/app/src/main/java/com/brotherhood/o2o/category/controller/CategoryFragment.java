...
public class CategoryFragment extends BaseFragment {
    ...
    private BroadcastReceiver mLocationChangedEventReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equalsIgnoreCase(LocationComponent.ACTION_ON_ADDRESS_CHANGED)) {
                onLocationChanged();
            }
        }
    };
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        LocationInfo addressOrNil = LocationComponent.shareComponent().getCachedCurrentAddressOrNil();
    ...
    void onLocationContainerClick() {
        LocationComponent.shareComponent().showSelectAddressPage(getActivity());
    }
