 ...
 * 海外版美食列表
 */
public class OverseaFoodListRequest extends BaseAppRequest<ResponseResult<List<FoodListItem>>> {
    public OverseaFoodListRequest(String url, OnBaseResponseListener<ResponseResult<List<FoodListItem>>> baseResponseListener) {
     ...
     * @return
     */
    public static OverseaFoodListRequest createFoodListRequest(double longitude, double latitude, int pageNo, int limit, String keyword, OnResponseListener<List<FoodListItem>> listener) {
        ...
        return new OverseaFoodListRequest(getUrl, listener);
    }
}
