...
public abstract class LoadMoreFragment<T, A extends RecyclerView.Adapter> extends BaseFragment implements
    ...
    @Override
    public void onlastVisibleItemPosition(int lastPosition) {
        ((LoadMoreRecylerAdatper) mRecyclerView.getAdapter()).isShowFootHint(lastPosition);
    }
