...
public abstract class BaseQuickAdapter<T,H extends BaseAdapterHelper> extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    protected MultiItemTypeSupport<T> mMultiItemSupport; //多样式扩�?
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        H helper = getAdapterHelper(context,parent,layoutResId,viewType,listener);
        return helper;
    }
     ...
     * @return
     */
    protected abstract H getAdapterHelper(Context context,ViewGroup parent,int layoutResId,int viewType,OnRecyclerItemClickListener listener);
