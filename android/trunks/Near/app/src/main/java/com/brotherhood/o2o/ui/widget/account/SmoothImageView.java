...
//      setBackgroundColor(mBgColor);
    ...
    public void setOriginalInfo(int width, int height, int locationX, int locationY) {
        ...
        mOriginalLocationY = mOriginalLocationY - DisplayUtil.getBarHeight(getContext());
    }
    ...
    protected void onDraw(Canvas canvas) {
        try {
            ...
            LogManager.e("====================SmoothImageView try to use a recycled bitmap=====================");
        }
    }
