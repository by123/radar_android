...
public class MessageHelper {
	...
	public void registerMessages() {
		...
		for (Message.Type messageType : mMessageTypes) {
			NearApplication.mInstance.getMessagePump().register(messageType, mMessageCallback);
		}
	}
	...
	public void unRegisterMessages() {
		...
		for (Message.Type messageType : mMessageTypes) {
			NearApplication.mInstance.getMessagePump().unregister(messageType, mMessageCallback);
		}
	}
