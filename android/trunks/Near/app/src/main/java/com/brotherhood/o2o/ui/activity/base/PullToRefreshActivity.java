...
public abstract class PullToRefreshActivity<T, A extends RecyclerView.Adapter> extends BaseActivity implements OnPullToRefreshListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (pullToRefresh()) {
            mPtrClassicController = new PtrClassicController.Builder(this).setOnPullToRefreshListener(this).builder();
        }
        if (overideLayout()) {
            overideInit();
