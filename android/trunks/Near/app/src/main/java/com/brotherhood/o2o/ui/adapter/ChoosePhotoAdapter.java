...
public class ChoosePhotoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private boolean hideCamera;//是否隐藏拍照
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case VIEW_TYPE_CAMERA:
                View viCamera = LayoutInflater.from(parent.getContext()).inflate(R.layout.choose_photo_camera_item, null);
    ...
    private void onBindPhotoViewHolder(final PhotoViewHolder holder, final int position) {
        ...
        holder.mCheckBox.setChecked(mSparseArray.get(position));
